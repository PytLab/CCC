    ...
    <body>
        ...
        <div id="page_num">
            ...
            <?php
                ...
                {
            ?>
            <a href="publications_list.php?page=1" title="First"><font face="webdings"> 9 </font></a> 
            <a href="publications_list.php?page=<?php echo $page-1;?>" title="Previous"><font face="webdings"> 7 </font></a>
            <?php
                }
                if($pagecount<=4)
                {
                    ...
                    {
            ?>
                <a href="publications_list.php?page=<?php echo $i;?>"><?php echo $i;?></a>
            <?php
                    }
                }
                else
            ...
            ?>
            ...&nbsp;<a href="publications_list.php?page=<?php 
                if($pagecount>=$page+1)
                    echo $page+1;
                else
                    echo 1; 
                ...
                <a href="publications_list.php?page=<?php echo $pagecount;?>" title="Last"><font face="webdings"> : </font></a>
            <?php 
                }
            ?>
            &nbsp;

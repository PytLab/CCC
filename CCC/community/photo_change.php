...
/* iFocus style */
#ifocus { width:770px; height:400px; margin:0px; border:0px solid #DEDEDE; background:#F8F8F8; -webkit-box-shadow: #999 0px 0px 2px;-moz-box-shadow: #999 0px 0px 2px;box-shadow: #999 0px 0px 2px;}
#ifocus_pic { display:inline; position:relative; float:left; width:660px; height:375px; overflow:hidden; margin:10px 0 0 10px; }
#ifocus_piclist { position:absolute; }
#ifocus_piclist li { width:670px; height:375px; overflow:hidden; }
#ifocus_piclist img { width:670px; height:375px; }
#ifocus_btn { display:inline; float:right; width:91px; margin:9px 9px 0 0; }
#ifocus_btn li { width:91px; height:54px; cursor:pointer; opacity:0.5; -moz-opacity:0.5; filter:alpha(opacity=50); }
#ifocus_btn img { width:75px; height:42px; margin:7px 0 0 11px; }

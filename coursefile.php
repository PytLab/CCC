...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="coursefile_main">
            ...
            <?php
                 echo "&nbsp;&nbsp;&nbsp;&nbsp;<a href='resource".$info_list[id]."'>".$info_list[title]."</a>&nbsp;-&nbsp;".$info_list[createtime];
            ?>            
                    </div>
            <?php
                }
            ...
            <div id="page_num" style="margin: 10px 90px 2px 90px">
                ...
                <?php
                    ...
                    {
                ?>
                        <a href="coursefile<?php echo $courseid;?>&1" title="First"><font face="webdings"> 9 </font></a> 
                        <a href="coursefile<?php echo $courseid;?>&<?php echo $page-1;?>" title="Previous"><font face="webdings"> 7 </font></a>
                <?php
                    }
                    if($pagecount<=4)
                    {
                        ...
                        {
                ?>
                            <a href="coursefile<?php echo $courseid;?>&<?php echo $i;?>"><?php echo $i;?></a>
                <?php
                        }
                    }
                    else
                ...
                ?>
                ...&nbsp;<a href="coursefile<?php echo $courseid;?>&<?php 
                    if($pagecount>=$page+1)
                        echo $page+1;
                    else
                        echo 1; 
                    ...
                    <a href="coursefile<?php echo $courseid;?>&<?php echo $pagecount;?>" title="Last"><font face="webdings"> : </font></a>
                <?php 
                    }
                ?>
                &nbsp;

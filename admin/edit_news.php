...
<table width="770" height="81" border="0" align="center" cellpadding="9" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#D4D4D4" class="look_cjwt">
	 ...
	 <?php
	   $sql=mysql_query("select * from tb_news order by id desc limit ".($page-1)*$pagesize.",$pagesize",$conn);
	 ...
	 ?>	
        ...
        <tr>
		  ...
		  ?></div></td>
          <td align="right" bgcolor="#F7F7F7"><div align="center"><a href="high_editor/blog_edit.php?id=<?php echo $info[id];?>">编辑</a></div></td>
          <td align="right" bgcolor="#F7F7F7"><div align="center"><?php echo $info[createtime];?></div></td>
          <td height="25" align="right" bgcolor="#F7F7F7"><div align="center"><a href="default.php?htgl=编辑公告&mtid=<?php echo $info[id];?>"></a><a href="javascript:if(window.confirm('您确定删除该信息么？')==true){window.location.href='delete_news.php?id=<?php echo $info[id];?>';}"><img src="graph/delete.gif" width="22" height="22" border="0"></a></div></td>
        </tr>
	 <?php
	      }
	  	}

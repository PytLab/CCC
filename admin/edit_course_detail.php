...
<table width="770" border="0" align="center" cellpadding="10" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#D4D4D4">
		...
		<form name="form1" method="post" action="save_edit_course.php" onSubmit="return chkinput(this)" enctype="multipart/form-data">
      ...
      <tr>
          ...
          <td width="564" bgcolor="#FFFFFF">&nbsp;
          <input name="teacher" type="text" class="txt_grey" id="teacher" size="70" value="<?php echo $info[teacher];?>"></td>
        </tr>
        ...
        <tr>
          ...
          <td width="564" bgcolor="#FFFFFF">&nbsp;<textarea name="info" rows="9" cols="70" class="textarea"><?php echo $info[info];?></textarea></td>
        </tr>
        
        <tr>
          <td height="55" colspan="2" bgcolor="#FFFFFF"><div align="center">
            
          <input type="submit" value="edit" class="login_submit">&nbsp;&nbsp;<input type="reset" value="reset" class="login_reset"></div></td>
        </tr>
		</form>
      </table>	  

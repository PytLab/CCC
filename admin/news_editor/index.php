...
<body>
   ...
   <div id="news_body">
   		<div id="editor">
            ...
            var eXSize = 500;       //编辑器宽度，最小宽度限588px
            var formU = 'run.php';  //表单执行文件
            var contT = '';         //待编辑文本
            var formT='<div id="news_title" style="color:#999;"><p style="color:#999;font-family:Microsoft YaHei;">Highlight标题</p><input name="subject" id="subject" value="<?php echo addslashes($subject); ?>" type="text"  maxlength="180"/ ><br /><p style="color:#999;font-family:Microsoft YaHei;">发表时间</p><input name="pubtime" id="subject"  type="text"  maxlength="180"/ ><p style="color:#999;">Highlight内容</p></div>';
            var path = '';          //相对路径

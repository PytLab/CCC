...
$pubtime=filter2($_POST['pubtime']);
$createtime=date("Y-m-j H:i:s");
if(mysql_query("insert into tb_highlights(pub_time,content,title,author,createtime) values ('".$pubtime."','".$news_content."','".$news_title."','".$author_name."','".$createtime."')",$conn))
 {

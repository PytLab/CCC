...
<table width="770" height="81" border="0" align="center" cellpadding="9" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#D4D4D4" class="look_cjwt">
	 ...
	 ?>
		<tr>
		  <td height="38" colspan="6" align="center" class="right_title" bgcolor="#909090"><?php echo $htgl;?></td>
  </tr>
		<tr>
          <td width="213" height="25" align="right" bgcolor="#F7F7F7"><div align="center">Name</div></td>
     	  <td width="213" height="25" align="right" bgcolor="#F7F7F7"><div align="center">Date</div></td>
          <td width="117" height="25" align="right" bgcolor="#F7F7F7"><div align="center">编辑Info</div></td>
           <td width="117" height="25" align="right" bgcolor="#F7F7F7"><div align="center">编辑Program</div></td>
          <td width="117" height="25" align="right" bgcolor="#F7F7F7"><div align="center">编辑Invitation</div></td>
          <td width="117" height="25" align="right" bgcolor="#F7F7F7"><div align="center">删除Meeting</div></td>
        </tr>
	 <?php
	   $sql=mysql_query("select * from tb_meeting order by id desc limit ".($page-1)*$pagesize.",$pagesize",$conn);
	 ...
	 ?>	
        ...
        <tr>
          ...
          <td align="right" bgcolor="#F7F7F7"><div align="center"><?php
		   echo $info[date]; 
		  ?></div></td>
           <td align="right" bgcolor="#F7F7F7"><div align="center"><?php echo "<a href='default.php?htgl=编辑meetinginfo&id=".$info[id]."'>编辑</a>"; ?></div></td>
          <td align="right" bgcolor="#F7F7F7"><div align="center"><?php echo "<a href='./meeting_editor/blog_edit.php?id=".$info[id]."'>编辑</a>"; ?></div></td>
          <td align="right" bgcolor="#F7F7F7"><div align="center"><?php echo "<a href='./meeting_invit_editor/blog_edit.php?id=".$info[id]."'>编辑</a>"; ?></div></td>
          <td height="25" align="right" bgcolor="#F7F7F7"><div align="center"><a href="javascript:if(window.confirm('您确定删除该信息么？')==true){window.location.href='deletemeeting.php?id=<?php echo $info[id];?>';}"><img src="graph/delete.gif" width="22" height="22" border="0"></a></div></td>
        </tr>
	 <?php
	      }
	  	}

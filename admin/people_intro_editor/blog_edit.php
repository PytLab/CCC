...
if($_SESSION["admin_nc"]=="")
 {
  ...
  exit;
    ...
    $info=mysql_fetch_array($sql);//get the people's info from db
	$name=$info[name];
	$interest=$info[Info];
?>
...
var contT = '<?php echo addslashes($interest); ?>';         //待编辑文本
var formT='<div id="news_title"><p style="color:#999;">Name</p><input name="subject" id="subject" value="<?php echo addslashes($name); ?>" type="text"  maxlength="180"/><input type="hidden" name="id" value="<?php echo $id;?>" /><p style="color:#999;">Introduction</p></div>';
var path = '';          //相对路径

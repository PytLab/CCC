...
<table width="770" border="0" align="center" cellpadding="10" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#D4D4D4">
		...
		<form name="form1" method="post" action="save_meeting.php" onSubmit="return chkinput(this)" enctype="multipart/form-data">
        ...
        <tr>
          ...
          <td width="564" bgcolor="#FFFFFF">&nbsp;
          <input name="date" type="text" class="txt_grey" id="date" size="70"></td>
        </tr>

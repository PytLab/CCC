...
<body>
   ...
   <div id="news_body">
   		<div id="editor">
            ...
            var contT = '';         //待编辑文本
            var formT='<div id="news_title" style="color:#999;"><p style="color:#999;font-family:Microsoft YaHei;">新闻标题</p><input name="subject" id="subject" value="<?php echo addslashes($subject); ?>" type="text"  maxlength="180"/ ><br /><p style="color:#999;">新闻内容</p></div>';
            var path = '';          //相对路径

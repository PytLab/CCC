...
if($_SESSION["admin_nc"]=="")
 {
  ...
  exit;
 	...
 	$id=$_GET[id];
 	$sql=mysql_query("select * from tb_news where id='".$id."'",$conn);
...
var formT='<div id="news_title"><p style="color:#999;">新闻标题(必填)</p><input name="subject" id="subject" value="<?php echo addslashes($title); ?>" type="text"  maxlength="180"/><input type="hidden" name="blog_id" value="<?php echo $id;?>" /><p style="color:#999;">新闻内容(必填)</p></div>';
var path = '';          //相对路径

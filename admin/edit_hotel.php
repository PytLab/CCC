...
<table width="770" height="81" border="0" align="center" cellpadding="9" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#D4D4D4" class="look_cjwt">
	  ...
	  $sql=mysql_query("select count(*) as total from tb_hotel",$conn);
	 ...
	 ?>
		...
		<tr>
          ...
          <td width="117" height="25" align="right" bgcolor="#F7F7F7"><div align="center">编辑BasicInfo</div></td>
           <td width="117" height="25" align="right" bgcolor="#F7F7F7"><div align="center">编辑Introduction</div></td>
          
          <td width="117" height="25" align="right" bgcolor="#F7F7F7"><div align="center">删除Meeting</div></td>
        </tr>
	 <?php
	   $sql=mysql_query("select * from tb_hotel order by id desc limit ".($page-1)*$pagesize.",$pagesize",$conn);
	 ...
	 ?>	
        ...
        <tr>
		  ...
		  ?></div></td>
           ...
           <td align="right" bgcolor="#F7F7F7"><div align="center"><?php echo "<a href='default.php?htgl=编辑hotelinfo&id=".$info[id]."'>编辑</a>"; ?></div></td>
          <td align="right" bgcolor="#F7F7F7"><div align="center"><?php echo "<a href='./hotel_editor/blog_edit.php?id=".$info[id]."'>编辑</a>"; ?></div></td>
          
          <td height="25" align="right" bgcolor="#F7F7F7"><div align="center"><a href="javascript:if(window.confirm('您确定删除该信息么？')==true){window.location.href='deletehotel.php?id=<?php echo $info[id];?>';}"><img src="graph/delete.gif" width="22" height="22" border="0"></a></div></td>
        </tr>
	 <?php
	      }
	  	}

...
if($_SESSION["admin_nc"]=="")
 {
  ...
  exit;
 	...
 	$id=$_GET[id];
 	$sql=mysql_query("select * from tb_hotel where id='".$id."'",$conn);
...
var contT = '<?php echo addslashes($info); ?>';         //待编辑文本
var formT='<div id="news_title"><p style="color:#999;">Meeting Name</p><input name="subject" id="subject" value="<?php echo addslashes($name); ?>" type="text"  maxlength="180"/><input type="hidden" name="id" value="<?php echo $id;?>" /><p style="color:#999;">Hotel Introduction</p></div>';
var path = '';          //相对路径

	 ...
	 ?>	
        ...
        <tr>
          ...
          <td align="right" bgcolor="#F7F7F7"><div align="center"><?php
		   echo $info[teacher]; 
		  ?></div></td>
          <td align="right" bgcolor="#F7F7F7"><div align="center"><?php echo "<a href='default.php?htgl=编辑course_detail&id=".$info[id]."'>编辑</a>";  ?></div></td>
          <td align="right" bgcolor="#F7F7F7"><div align="center"><a href="javascript:if(window.confirm('您确定删除该信息么？')==true){window.location.href='deletecourse.php?id=<?php echo $info[id];?>';}"><img src="graph/delete.gif" width="22" height="22" border="0"></a></div></td>
        </tr>
	 <?php
	      }
	  	}

...
var formT='<div id="news_title"><p style="color:#999;">Name</p><input name="subject" id="subject" value="<?php echo addslashes($name); ?>" type="text"  maxlength="180"/><input type="hidden" name="id" value="<?php echo $id;?>" /><p style="color:#999;">Interest</p></div>';
var path = '';          //相对路径

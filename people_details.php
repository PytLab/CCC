                ...
                ?>
                        <div id="pub_page_num">
                            ...
                            <?php 
                                ...
                                {
                            ?>
                                    <a href="people<?php echo $id;?>&1#details_pub" title="First"><font face="webdings"> 9 </font></a> 
                                    <a href="people<?php echo $id;?>&<?php echo $page-1;?>#details_pub" title="Previous"><font face="webdings"> 7 </font></a>
                            <?php
                                }
                                /*显示页面切换键*/
                                if($page_count <= 5)
                            ...
                            ?>
                                ...
                                <a href="people<?php echo $id;?>&<?php echo $page_count;?>#details_pub" title="Last"><font face="webdings"> : </font></a>
                            <?php
                                }
                            ?>
                        </div>
